...
class BlackBoard {
 ...
 GEORDI_PUBLIC:
  ...
  SmartMember<bool> intersection_handled;  // flag indicating that the intersection has been handled
  ...
  SmartMember<int> next_intersection;  // if mapping is finished, localization will update
